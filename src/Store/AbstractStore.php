 ...
 * @copyright 2015
 */
abstract class AbstractStore implements Countable, Serializable, Iterator
{
  ...
  {
    if (is_array($value)) {
      return $this->instantiate($value, $this);
    }
  ...
  {
    return $this->instantiate(array_keys($this->data));
  }
  ...
  {
    return $this->instantiate(array_values($this->data));
  }
